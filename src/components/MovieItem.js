    ...
    return (
        <Box borderWidth="1px" borderRadius="lg" mt={5} p={3}>
            <Flex justify="flex-start" align="center">
                {movie.Poster === 'N/A' ? <Image src='https://via.placeholder.com/150' cursor="pointer" width={50} mr={3} alt={movie.title} /> : <Image src={movie.Poster} cursor="pointer" width={50} mr={3} alt={movie.title} />}
